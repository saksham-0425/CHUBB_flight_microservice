...
public class GlobalExceptionHandler {
    ...
    // ============================
    // 400 - CANCELLATION NOT ALLOWED (24-HOUR RULE)
    // ============================
    @ExceptionHandler(CancellationNotAllowedException.class)
    public ResponseEntity<String> handleCancellationNotAllowed(
    ...
    // ============================
    // 503 - FLIGHT SERVICE DOWN
    // ============================
    @ExceptionHandler(FlightServiceDownException.class)
    public ResponseEntity<String> handleFlightServiceDown(
